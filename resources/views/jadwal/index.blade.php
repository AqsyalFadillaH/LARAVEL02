...
<body class="bg-gray-50">
    <div class="flex">
        <!-- Sidebar (same as presensi and tugas) -->
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Daftar Jadwal Kuliah</h1>
                    <p class="text-gray-500">Kelola jadwal kuliah mahasiswa</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 card-hover">
                <h3 class="text-xl font-semibold text-gray-800 mb-4">Data Jadwal Kuliah</h3>
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-blue-50 text-blue-700">
                                <th class="px-4 py-3 font-medium rounded-l-lg">Mata Kuliah</th>
                                <th class="px-4 py-3 font-medium">Dosen</th>
                                <th class="px-4 py-3 font-medium">Ruangan</th>
                                <th class="px-4 py-3 font-medium">Tanggal</th>
                                <th class="px-4 py-3 font-medium rounded-r-lg">Jam</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($jadwals as $jadwal)
                                <tr class="border-b border-gray-100 hover:bg-blue-50 transition">
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 rounded-full text-sm bg-blue-100 text-blue-600">
